...
-- Volunteer delivered supplies table
...
-- Donor role donation tracking note:
-- donations.donation_id is used as the Donation ID shown as #DON-00001.
-- donation_usage links each donation to camp/item usage so donors can track where it was used.


-- Links affected person login accounts to registered affected family records.
-- Also controls whether affected people are allowed to chat with camp support.
